...
makes it rage.
It can pull nearby enemies down into the water (removing \glspl{ap}), or make barrels explode and pool together onto the ground.

\paragraph{Waning Water}
makes it slow down, and eventually stop.
Water may turn to ice, or magma turns to cold stone.
...
lets the caster detect its presence.
Detecting a clear stream has \tn[7], while detecting ale might have \tn[10].
Finding someone through the water in their veins would have at least \tn[16] as the liquid is bound up with a complete organism.
