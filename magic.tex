...
\begin{description}
  \item[Waxing Water]
  accelerates and distorts its flow. If the flow is made circular or unevenly
  ...
  \item[Waning Water]
  makes it slow, sluggish, and polluted.
  ...
  \item[Warping Water]
  can scatter it to a fine mist (like Air) or harden it to ice (like Earth).
...
\begin{description}
  ...
  \item[Waning Air]
  projects an invisible sieve that can filter the vitality from a room like a breath held overlong, or thin the air as if it was stretched to cover a high mountaintop.
  Anyone forced to breathe within the spell's area receives \glspl{ep}.
  A decrease in air pressure may incidentally encourage airborne moisture to adhere to other particulates, reducing visibility.
  ...
  \begin{description}
    \item[Detailed Waning Air]
    \glspl{spell} refine the sieve, granting more precise control over cloud formation.
  \end{description}
...
\begin{description}
  ...
  \item[Waning Earth]
  first fractures it and breaks it into fragments, and with persistence
  can round those fragments and grind them into dust.
...
\begin{description}
  ...
  Bigger creatures must feed and rest more often.
  Extra Strength demands more \glspl{ration}, while gaining extra Speed means quickly overheating, which inflicts \glspl{ep} with every exertion.
  ...
  These \glspl{spell} mutate legs into tentacles or hands into wings or fingers into claws.
