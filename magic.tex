...
\footnote{Each number is simply $n^n$, rounded up.  So spending 3~\glsfmtplural{mp} means $3^3 = 3\times 3\times 3 = 27$ targets, which rounds to 30.}% This avoids the number `46656', which can scare people, apparently.
