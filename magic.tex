...
\begin{description}
  ...
  \begin{description}
    \item[Detailed Witness Mind]
    \glspl{spell} detect particular thoughts, like `murder' or `food' at the second level, then `murder for profit' or `murder for vengeance' at the third level, and so on, with each level demanding a more specific question.
  \end{description}
\end{description}
...
\begin{description}
  ...
  \begin{description}
    \item[Detailed Wax Death]
    \glspl{spell} can remove \glspl{hp} \emph{directly} instead of \glspl{ep}, without regard for \glspl{fp} or \gls{dr}.
  \end{description}

  \item[Waning Death]
  let targets put aside \glspl{ep} for a short time, before they return.

  \begin{description}
    \item[Detailed Waning Death]
    \glspl{spell} immunise targets against some type of degradation.
    Damage and \glsentrylongpl{ep} raise the \glsentrylong{tn}.
    When cast on perishables like food or \glspl{ingredient}, they can slow rot considerably.
  \end{description}
...
\begin{description}
  ...
  \begin{description}
    \item[Detailed Wax Force]
    \glspl{spell} can increase the momentum of a weapon or projectile in just the right way to increase Damage.
  \end{description}
  ...
  \begin{description}
    \item[Detailed Waning Force]
    \glspl{spell} can target those forces directed at someone, reducing Damage to the target from all sources.
  \end{description}
