...
\subsubsection{Spells Live Until They Die}
...
If a witch fills a castle with sentient illusions, they can remain for a millennium, but a lightning storm cannot crack and blow forever, because it burns through itself a little more with every motion.
...
So spell Stacking works exactly like armour -- wearing chainmail on top of plate will not work well, but a character could gain \gls{dr} by hardening their own skin with a Life spell, and then add armour.
The lowest of the two armour-types would only count for half, as usual.%
