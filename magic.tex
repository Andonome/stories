...
Duplicated spells seep through contiguous targets until they spend their energy on enough mass, so a \textit{Duplicated Wax Water} spell which reaches a river will affect a large section of that river, but will never affect a nearby barrel or tankard.
...
A sufficiently irate and prolific spell can eradicate \pgls{village}.
