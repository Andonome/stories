...
\begin{nametable}[|l|>{\scshape\raggedright\arraybackslash}p{.15\linewidth}>{\scshape\arraybackslash}l>{\scshape\arraybackslash}l|>{\small\arraybackslash}L|]{The Anatomy of Magic}
