...
\begin{description}
  ...
  \textit{Detailed}
  Fate \glspl{spell} can tie \glspl{fp} to particular \glspl{action}, giving someone courage the next time they attempt that task.

  \textit{Detailed Waxing}
...
\begin{description}
  ...
  \textit{Detailed}
  \glspl{spell} can target particular people, the standard `Wax Fire' \gls{spell} simply makes it explode in all directions, burning anyone next to it.
