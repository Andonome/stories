...
\noindent
`\Glspl{ingredient}' let spell-casters an alchemists alike infuse mana into items.
...
requires reducing an \gls{ingredient} into a powder or liquid, slowly, then sealing it quickly; many use cheese-cloth or a phial.

After \pgls{interval}, the character rolls \roll{Intelligence}{Crafts}, at \tn[10].
Success means that the \gls{boon} can boost anyone's rating in an elemental Sphere by 1.
