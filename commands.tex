...
\newcommand\exampleRandomCharacter{
  \renewcommand\csComments{
      ...
      \commentary{[xshift=8em,yshift=-8em]TCBPOSTER@Derstats.east}{0em,6em}{}
      \commentary{[xshift=8em,yshift=-8em]TCBPOSTER@Derstats.east}{-19em,-2em}{{\LARGE \ref{ccConcept}: }Your lowest and highest Attributes determine your Concept and Code (see \nameref{enlistment}, \vpageref{enlistment}).  Write down the Skills, equipment, and weapons.}
      \commentary{[xshift=3em,yshift=0em]TCBPOSTER@knacks.east}{-18em,28em}{}
      \commentary{[xshift=3em,yshift=0em]TCBPOSTER@knacks.east}{-17em,12em}{{\LARGE \ref{ccDerived}: }Place coins in the circles to keep track of the current scores, then fill in the derived score for combat.}
  }
