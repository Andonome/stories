...
\newcommand\exampleRandomCharacter{
  \renewcommand\csComments{
      ...
      \commentary{[xshift=0em,yshift=-1em]TCBPOSTER@skills.north east}{-4em,-11em}{{\LARGE \ref{ccConcept}: }Your lowest and highest Attributes determine your Concept and Code (see \nameref{enlistment}, \vpageref{enlistment}).  Write down the Skills, equipment, and weapons.}
