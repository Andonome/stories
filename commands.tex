...
\renewcommand\csComments{
    ...
    \commentary{[xshift=0em,yshift=0em]TCBPOSTER@skills.south west}{1em,2em}{{\LARGE \arabic{track}: } Write down any Skills or Knacks (check \autopageref{knacks} for Knacks).}
