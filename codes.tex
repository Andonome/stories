...
\begin{boxtable}[YLcc]
  \textbf{Mundane Date} & \textbf{\Glsfmttext{fenestra} Date} & \textbf{\Glsfmttext{xp}} & \textbf{\Glsfmttext{fp}} \\
  \hline
     \realMonth       & \describeFullCycle       &   \runningXPtotal{50}  &   \arabic{fp}  \\
     \realMonth       & \describeFullCycle       &   \runningXPtotal{25}  &   \arabic{fp}  \\
     \Repeat{2}{ \realMonth       & \describeFullCycle       &   \runningXPtotal{4}  &   \arabic{fp}  \\ }
     \Repeat{2}{ \realMonth       & \describeFullCycle       &   \runningXPtotal{3}  &   \arabic{fp}  \\ }
     \hline
     \setcounter{xp}{50}
     \realMonth       & \describeFullCycle       &   \runningXPtotal{0}  &   \arabic{fp}  \\
     \realMonth       & \describeFullCycle       &   \runningXPtotal{28}  &   \arabic{fp}  \\
     \realMonth       & \describeFullCycle       &   \runningXPtotal{19}  &   \arabic{fp}  \\
     \Repeat{2}{ \realMonth       & \describeFullCycle       &   \runningXPtotal{3}  &   \arabic{fp}  \\ }
\end{boxtable}

Once \pgls{pc} dies, the next returns with \glspl{storypoint} equal to the previous character's \glspl{fp}.
