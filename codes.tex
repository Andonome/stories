...
\begin{itemize}
  \item
  Tracking potential weaknesses of those in power.
  \item
  Upsetting someone's plans (could be an ambush, could be misinforming someone of which road to take).
  \item
  Make someone's daily routine impossible (by vandalising their tools, questioning their ideals, or anything else).
  \item
  Uprooting the habits of an institution (maybe stop the brochs using pipes at morning and evening, or stop wardens having a jester in court).
\end{itemize}

\begin{enumerate}
  \item
  Donating 1 \gls{sp} to the poor.
  \item
  Donating 5 \glspl{sp} to the poor.
  \item
  Donating as many \glspl{sp} to the poor as the character has \glspl{xp}.
\end{enumerate}
