...
\begin{itemize}
  ...
  \item
  Martial Skills also increase sharply, so learning a little of everything comes easier than mastering a single Skill.
  \item
...
\begin{boxtable}[cLL]
  \textbf{Real Time} & \textbf{\Gls{fenestra} Time}       & \textbf{\glspl{xp}} \\
  \hline
          0          & \describeFullSeason{0}             &    50    \\
     1 month         & \describeFullSeason{1}             &    87    \\
     2 months        & \describeFullSeason{1}             &    99    \\
     3 months        & \describeFullSeason{1}             &   111    \\
     \ldots          & \ldots                             &   \ldots \\
     6 months        & \describeFullSeason{3}             &   147    \\
     9 months        & \describeFullSeason{6}             &    87    \\
\end{boxtable}
