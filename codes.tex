...
\begin{boxtable}[YLcc]
  ...
  \hline
          0          & \describeFullCycle{0}             &   \runningXPtotal{50}  &   \arabic{fp}  \\
     1 month         & \describeFullCycle{2}             &   \runningXPtotal{37}  &   \arabic{fp}  \\
     2 months        & \describeFullCycle{2}             &   \runningXPtotal{12}  &   \arabic{fp}  \\
     3 months        & \describeFullCycle{2}             &   \runningXPtotal{12}  &   \arabic{fp} \\
     \ldots          & \ldots                            &   \ldots               &   \ldots \\
     6 months        & \describeFullCycle{6}             &   \runningXPtotal{36}  &   \arabic{fp} \\
     \ldots          & \ldots                            &   \ldots               &   \ldots \\
     9 months        & \describeFullCycle{6}             &   \runningXPtotal{36}  &   \arabic{fp} \\
\end{boxtable}
