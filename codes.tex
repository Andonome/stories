...
When recapping the last session, any number of players can gain \pgls{xp} if they all help with the recap.
...
Telling people things isn't helpful unless they want and use the advice.
...
An in-character voice means declaring standard \glspl{action} as a character, rather than a player describing mechanics.
Declaring combat actions in this way does not cost \pgls{ap} unless the player also makes a statement or requset to other players.
