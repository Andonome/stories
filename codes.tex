...
They gain either 1, 2, or 3 \glspl{xp}, depending on how much they spend.

\subsection{Conqueror}

We go beyond the \gls{edge}, no to drink or talk, but for the unending war with the forest.
We leave to kill and subdue every creature, and to conquer our enemies who live beyond our walls.
...
\begin{enumerate}
  \item
  Using 1 \gls{sp}'s worth of weapons.
  \item
  Using 5 \glspl{sp}'s worth of weapons.
  \item
  Using as many \glspl{sp}'s worth of weapons as the character has \glspl{xp}.
\end{enumerate}
...
The best of adventurers exist to uphold the law and make sure the local populace can trust in them, and the law.
...
\begin{itemize}
  ...
  \item
  Fulfilling an oath set up on a previous session.
  \item
  Capturing a more troublesome law-breaker than ever before.
\end{itemize}

Paladins spend their additional money on whatever local temple they pray to.
...
Exactly who counts as `in the tribe' depends upon the player's interpretation, but it will generally include any \glspl{pc} who have been involved in three or more sessions with them, and anyone the player decides to spend Story Points on (see \autopageref{stories}.
...
\noindent
\Glsentrylongpl{xp} let characters grow over time.
Buying low-level Traits does not require much, but higher level Traits become increasingly expensive.

Each character's total \glspl{fp} equals their total \glspl{xp} divided by ten, so players should always take care to record how many \glspl{xp} they have earned.

Players can earn a maximum of 7 \glspl{xp} per mission from following their Codes, but will most often earn less.
So purchasing a +3 Attribute bonus can take multiple sessions.

Of course, \glspl{pc} also start with bonus \glspl{xp} in the form of \glspl{storypoint}.
