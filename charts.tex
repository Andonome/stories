...
\renewcommand\csComments{
    ...
    \commentary{[xshift=5em,yshift=5em]TCBPOSTER@armoury.north west}{-1em,-2.5em}{{\huge\ref{sumCCequip}:} Check your reaons for enlisting, and take your starting equipment (\autopageref{enlistment_equipment}).}
}
