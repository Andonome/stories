...
\renewcommand\csComments{
    ...
    \commentary{[xshift=18em,yshift=-8em]TCBPOSTER@title.west}{5em,5em}{}
    \commentary{[xshift=18em,yshift=-8em]TCBPOSTER@title.west}{-5em,5em}{{\LARGE \arabic{track}: }Put down your name, roll a random race (\autopageref{raceRoll}), then use that to select a name (\autopageref{randomNames}).}

    \commentary{[xshift=0em,yshift=-1em]TCBPOSTER@attributes.south}{0em,0em}{{\LARGE \arabic{track}: }Roll to determine each of your Attributes, then apply the racial modifier.}

    \commentary{[xshift=-7em,yshift=-9em]TCBPOSTER@title.east}{-1em,1em}{{\LARGE \arabic{track}: } Once you have your Attributes, check why you enlisted into the \gls{guard}, and fill in what's there, starting with your Code (\autopageref{enlistment}). Your rank is `Novice'.}

    \commentary{[xshift=0em,yshift=2em]TCBPOSTER@skills.south west}{-4em,9em}{}
    \commentary{[xshift=0em,yshift=2em]TCBPOSTER@skills.south west}{2em,2em}{{\LARGE \arabic{track}: } Mark down any Skills or Knacks (below).}

    \commentary{[xshift=0em,yshift=0em]TCBPOSTER@armoury.south}{-3em,-15em}{}
    \commentary{[xshift=0em,yshift=0em]TCBPOSTER@armoury.south}{-8em,12em}{}
    \commentary{[xshift=0em,yshift=0em]TCBPOSTER@armoury.south}{-9em,4em}{{\LARGE \arabic{track}: } Put your weapons and any armour where you can use them, then check their stats (\autopageref{commonWeapons}).
    Put anything else in the backpack, or don't, I'm not your seargent.}
