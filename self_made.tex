\section{Induction at the \Glsfmttext{templeOfBeasts}}
...
Of course, the \gls{gm} may give you a different \gls{tn}\ldots
...
\noindent
Over \pgls{campaign} you can make extra characters by spending \glspl{storypoint}.
The `\nameref{designCharacter}' story (\vpageref{oldFriend}) lets you build characters by spending the initial 50~\glspl{xp} yourself to determine every \gls{trait}.
