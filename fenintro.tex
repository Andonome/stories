...
\begin{exampletext}
  ...
  Along the road, you'll find various \glspl{broch} -- tall towers, often with enough room for traders to sleep with their horses, and some firewood.
  Every \gls{broch} began where someone died on the road.
  If enough people bring rocks to commemorate them, they can make \pgls{broch}, and nobody else has to die there.
  Most trader caravans can't travel much more than 10 miles during the daylight, so they need \pgls{broch} to sleep, and we need them for weapons, rations, ropes, and the rest.

  We look after \glspl{broch} as our temples -- so remember that every one of them is sacred, and when you arrive, take a moment to read the name beside the door.
  The \gls{broch}'s name comes from the person who died there on the road.
  And remember the golden rule -- you always leave \pgls{broch} as well as you found it, or better.
