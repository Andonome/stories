...
Well, not `lips'.
  ...
  Sometimes we lose whole cities, to curses which bring beasts out of the forests, or maybe they'll just turn a town's walls to ice on a warm day and watch those walls melt while the beasts comes in to eat the village.
...
\begin{exampletext}
  ...
  Of course everyone makes small windows, but sometimes they'll manage to crack the wooden frame open, or just grab a baby.
  Once the screaming starts, the creature gives you maybe one shot, maybe two, then it's off into the darkness.

  It turned out someone had left his window open, and the child next to it.
...
\begin{exampletext}
  ...
  I guess you know, when the forest eats you, Rava collects your soul, and turns you into a monster.
  Well the barracks we're going to is also our temple.
  A \gls{guard} temple to ward \emph{her} off.

  Look over there -- that's an image of Niquis, the god who takes your soul when you die of cold.
  Inside you can listen at the Temple of the Weavers -- the Guild that makes clothes to ward off Niquis.
  ...
  Personally, I want to go with Yerna.
