...
\Glspl{pc} can start off as blank slates with no history, but history emerges naturally, as you spend the character's \glspl{storypoint} to bring summon aspects of their past to help with the current mission.
