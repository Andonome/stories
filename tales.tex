...
Roll up a random character, as per \nameref{randomCharacterCreation}, \autopageref{randomCharacterCreation}, but their race is the same as yours.
...
This can be a useful Story to tell if you've rolled up a random character who turned out to be very useful.
...
\begin{itemize}
  ...
  \item
  The bandits are catching up soon, but you recall \pgls{village} nearby.
...
The first three times you enter your hometown, you can spend \pgls{storypoint} (but you cannot save them, and gain no additional \glspl{xp} from them).
