...
\begin{enumerate}
  ...
  Otherwise, roll on the chart \vpageref{randomCharacterCreation}.
  \item
  Roll random \glspl{attribute} \vpageref{randomAttributes}.
  \item
...
\begin{itemize}
  \item
  With no idea how to talk to the local \gls{warden}, you suddenly find your old friend, working as \pgls{sunGuard} by the \gls{warden}'s gate.
  \item
