...
\begin{itemize}
  ...
  Later characters begin with a number of \glspl{storypoint} equal to the previous character's \glspl{xp} divided by 10.%
  \footnote{This rule allows players to retain some of their \glspl{xp} through death.
  If a player earns a total of 50~\glspl{xp} during \pgls{campaign}, their \gls{pc} would have a total of 100~\glspl{xp}, which means the next \gls{pc} would begin with 10~\glspl{storypoint}.
  That gives them an extra 25~\glspl{xp} once spent.} (minimum of 5)
  \item
...
\begin{exampletext}
  \begin{itemize}
    ...
    But here's your little sister, who just got arrested, and just got left alone in the \gls{sunGuard}'s station for five minutes.
