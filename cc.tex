...
%    {}% Equipment
  ...
  \showConcept{Wits}%Attribute
    ...
    {}% Stats
    {
      a rapier, a dagger, a tinder-box, a torch, and a rumour you overheard about another \gls{pc}.
    }% Equipment
...
\begin{itemize}
  ...
  \showConcept{Strength}%Attribute
    ...
    {
      a longsword, complete leather armour, three days of rations, 50 \glspl{cp}, and a knot-puzzle you cannot solve.
    }% Equipment
  ...
  \showConcept{Speed}%Attribute
    ...
    {a short sword, partial leather armour, and \arabic{r12} \glspl{cp}.}% Equipment
  ...
  \showConcept{Intelligence}%Attribute
    ...
    {a rapier, partial leather armour, a hidden vial of poison (deals 4 \glspl{fatigue} per \gls{interval} for 4 \glspl{interval}).}% Equipment
  ...
  \showConcept{Charisma}%Attribute
    ...
    {a broken sword, once-complete (now partial) leather armour, 3 \glspl{sp}, and some helpful advice for the player to your left.}% Equipment
...
\begin{itemize}
  ...
  {Noble}% Code
  {Combat 1, Projectiles 1, Crafts 1, Deceit 1, Stealth 2, Wyldcrafting 1}% Stats
  {a javelin, partial leather armour, 80 \glspl{cp}, and nasty black eye.}% Equipment
  ...
  {X}% Code
  {X}% Stats
  {writing equipment, three torches, and a dagger.}% Equipment
  ...
  {X}% Code
  {X}% Stats
  {a short sword, a dagger, and 2 \glspl{sp}.}% Equipment
  ...
  {X}% Code
  {X}% Stats
  {a longsword, complete leather armour, and an attitude problem.}% Equipment
...
\begin{itemize}
  ...
  {X}% Code
  {X}% Stats
  {a greatsword, partial chain armour, and disgust for the weak.}% Equipment
  ...
  {X}% Code
  {X}% Stats
  {a short sword, and a list of three obvious things you don't understand about the world.}% Equipment
  ...
  {X}% Code
  {X}% Stats
  {a longsword, partial chain armour, and a reason you don't need to listen to people who think they're clever.}% Equipment
...
\begin{itemize}
  ...
  {X}% Code
  {X}% Stats
  {a longsword, partial chain armour, and 10 \glspl{cp}.}% Equipment
  ...
  {X}% Code
  {X}% Stats
  {a rapier and a sob story of the time you should have looked ahead.}% Equipment
...
\begin{itemize}
  ...
  {X}% Code
  {X}% Stats
  {a greatsword, partial chain, and 50 \glspl{cp}.}% Equipment
