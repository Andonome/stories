...
Specifically, you will build \pgls{pc}.
...
\setglossarypreamble[symbols]{
  ...
  Now you can roll to find our the character's race with the chart \vpageref{Roch_Hercka/five_races}.
...
\index{Dwarves!Names}
Dwarven surnames come from their mother's occupation, although anything with more than two syllables reduces to two (dwarves are busy people).
So the surname `Spector' comes from `inspector', and if that dwarf's mother later finds a job as a cave surveyor, he would change his surname to `Veyor'.
