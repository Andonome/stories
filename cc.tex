...
\begin{itemize}
  ...
  \showConcept{Speed}%Attribute
    ...
    {Noble}% Code
    {
      Projectiles~1, Athletics~2, Crafts~1, Cultivation~1, Empathy~1, Vigilance~1, the Knack
      \laststand.
    }% Stats
    {
...
\begin{itemize}
  ...
  \showConcept{Speed}%Attribute
    {Klutz}% Concept
    {You zip about and run into people as if running backwards.
      We all laughed until you joined the \gls{burn} and set fire to \pgls{village}'s walls.
      Now you'll sleep outside the walls until you repay your debt.}% Description
    {Chronicler}% Code
  ...
  \showConcept{Intelligence}%Attribute
    ...
    {Too good to speak with the farmers, too useless to weave with the weavers.
      Last week the \gls{warden} pronounced noctavigation a crime!
      Time to find a place in the most accepting \gls{temple} in all the land\ldots}% Description
    {Conqueror}% Code
    {
...
\begin{itemize}
  ...
  \showConcept{Strength}%Attribute
    ...
    {some \rations, \rations, \rations, a great sword, partial chain (you cannot wash the \gls{basilisk}-stench off the tunic), a frying pan, and a craving for something in particular\ldots.}% Equipment
