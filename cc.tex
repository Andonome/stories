...
\begin{itemize}
  ...
  {a javelin, partial leather armour, \arabic{r12}0 \glspl{sp}, and nasty black eye.}% Equipment
...
\begin{itemize}
  ...
  {a longsword, partial chain armour, and \arabic{r12} \glspl{cp}.}% Equipment
