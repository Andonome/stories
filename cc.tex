...
\dicef{1} & Th   & --alin   & --oshell    \\
\dicef{2} & D    & --urg    & --ragsi     \\
\dicef{3} & M    & --eel    & --well      \\
\dicef{4} & G    & --imlen  & --itten     \\
\dicef{5} & B    & --enlak  & --lot       \\
\dicef{6} & K    & --rindal & --lasi      \\
...
\begin{itemize}
  ...
  {a javelin, partial leather armour, \arabic{r12}0 \glspl{sp} buried nearby, and nasty black eye (-1 \gls{hp}).}% Equipment
