\chapter[Five Cultures Tavern]{Races \& Cultures}
\index{Cultures}
\label{races}
...
Gnolls live in the upcoming moments, where they can make real decisions.
They listen well, look about, and act when they feel the right moment has arrived.

Their habit of asking straight-forward questions comes across as brutish, and invasive to many others (including other Gnolls), but the habit serves them well.

Keep your ears open for someone relevant, then pounce on them (one way or another).
Keep up to date with everyone's health.
Are your companions doing okay?
Make sure you have enough rations for tomorrow, and let the day after tomorrow do what it may.
...
Humans love stories.
They make little distinction between true and false stories -- they care more about making a story \emph{fun}.

Make a habit of saying `\textit{this remind me of the time\ldots}', and just keep talking.
And whenever something fun, or awful, or exciting, or messy happens, remember to tell the story to the next person you meet, even if you don't know them.
