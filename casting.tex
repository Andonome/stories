  ...
  \item[Warp]
    ...
    \begin{description}
      \item[People]
        ...
        \end{description}
      \item[Spirits]
        targeted by the spell can reach across the barriers between worlds, which makes it easier for them to interact with the world of the living.
        \begin{description}
          \item[Detailed]
            spells which target spirits can bind them to the material plane.
            The mage might place such a spirit in a sword, statue, or anything else.
            This allows the spirit to affect the material world with magic, if they have any.
        \end{description}
    \end{description}
  \item[Witness]
  ...
  spells cause growth.
    \begin{description}
      \item[Creatures]
        ...
        \footnote{If the spell lasts a long time, \pgls{pc} may begin spending \glspl{xp} on increasing their Dexterity. When they return to their normal form, they can reassign the spent \glspl{xp} to Dexterity, but will have to keep track of two \gls{xp} and Dexterity totals (or even more, if they live long-term with different versions of the spell).}
...
\begin{description}
  \item[Wax]
    ...
    \begin{description}
      \item[Detailed]
        spells bloom whatever collection of thoughts exist in the target's head into a fully-formed mind.
        When cast on a person, this results in a demonic voice in their head, beckoning them to do this or that.
        When cast on a non-sentient creature, the new mind takes full control.
  ...
  \item[Wane]
    ...
    \end{description}
  \item[Warp]
    spells twist the fundamentals of the mind operates, rewiring one Skill to another.
    ...
    \begin{description}
      \item[Detailed]
        warping spells can rewire how someone thinks entirely, or blossom a simple-minded creature into something fully sentient.

        The new creature begins with the same Mind Attributes as the caster, and one Skill point for each level of the spell.
        If the spell went off successfully, the caster can select these Skills.
        If not, the \gls{gm} will select which Skills the new mind acquires, and is duty-bound to make trouble\ldots
    \end{description}
  \item[Witness]
