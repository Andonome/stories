...
\begin{enumerate}
  ...
  \begin{description}
    ...
    \textit{Crumbling stone with a `detailed wane earth' spell may reveal a statue on the inside of the shattered rock.
    ...
    \item[Divergant]
    spells combine an extra sphere (low or high), along with all of the regular effects new targets.
